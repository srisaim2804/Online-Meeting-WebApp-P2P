...
// const {meeting_server, rooms_server, signalling_server} = require('../../server_links.cjs');
import { meeting_server, rooms_server, signalling_server } from '../../server_links.js';
...
function App() {
  ...
  async function createMeeting() {
    ...
    try {
      const response = await fetch(meeting_server + '/scheduleMeeting', {
        method: 'POST',
        headers: {
  ...
  async function joinMeeting() {
    ...
    try {
      const response = await fetch(meeting_server + '/joinMeetingNow', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      await Cookies.set('roomId', data.room_id);
